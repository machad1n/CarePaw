...
O **CarePaw** busca oferecer uma **experiência interativa** que conecte pessoas interessadas na causa do bem-estar animal e ONGs. Permitindo que, por meio de um **dashboard intuitivo**, os **usuários** colaborem e visualizem dados relacionados a cães e gatos em situação de vulnerabilidade, e também acessem informações e acompanhem estatísticas.
